...
@WebServlet(name = "VistaInicioUsuario", urlPatterns = {"/VistaInicioUsuario"})
public class VistaInicioUsuario extends HttpServlet {

    private UsuarioRegistrado usu;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("          <span class='card-title pink-text darken-3-text'>Bienvenido "+usu.getNombre()+" "+usu.getApPaterno()+":</span>");
